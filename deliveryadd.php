...
<form class="card-body" action="index.php?page=confirmdelivery" method="post">
              ...
              <!--Grid row-->
              <?php
              $sql="SELECT * FROM tblcustomer WHERE customer_id ='$uid'" ;
          ...
          $row = $result->fetch_assoc();
              ...
              <div class="md-form input-group pl-0 mb-5">
                ...
                <input type="text" class="form-control py-0" placeholder="Username" aria-describedby="basic-addon1"  id="customername">
              </div>

              <!--email-->
              <div class="md-form mb-5">
                <input type="text" id="email" class="form-control" placeholder="youremail@example.com"  id="email">
        ...
        <div class="col-md-4 mb-4">
          ...
          ?>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              ...
              <span class="text-muted"><?php echo $price;?> <b>MMK</b></span>
            ...
            ?>
            <?php
          $sql="SELECT SUM(total_price) FROM tblcart WHERE cart_session_id ='$sid'" ;
          $result = $conn->query($sql)or die($conn->error);
          while ($row = $result->fetch_assoc())
          {
            $mmktotal=$row['SUM(total_price)'];
            $mmktotall=number_format($row['SUM(total_price)']);
            $_SESSION['total_price']=$mmktotal;
          }
          ?>
